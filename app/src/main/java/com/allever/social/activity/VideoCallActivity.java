...
public class VideoCallActivity extends CallActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.my_em_activity_video_call);

        this_handler = new Handler(){
            @Override
            public void handleMessage(Message msg) {
                switch (msg.what){
                   case OkhttpUtil.MESSAGE_GET_VIDEO_CALL_INCOME:
                       handleVideoCallIncome(msg);
                       break;
                    case OkhttpUtil.MESSAGE_GET_VIDEO_CALL_MIN_COUNT:
                        handleVideoCallMinCount(msg);
                        break;
                }
            }
        };
...
//        toggleVideoBtn.setOnClickListener(this);
        ...
        if (isInComingCall == false){//总是接听方的显示  不是我发的请求
    ...
    private void getVideoCallMinCount(){
        OkhttpUtil.getVideoCallMinCount(this_handler, username);
    }
    ...
    private void handleVideoCallIncome(Message msg){
        String result = msg.obj.toString();
        Gson gson = new GsonBuilder().setDateFormat("yyyy-MM-dd").create();
        ...
        Toast.makeText(this,"赚了 " + root.income_credit + " 信用", Toast.LENGTH_LONG).show();
                    ...
                    case ACCEPTED: // 电话接通成功
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (isInComingCall == false){//总是接听方的显示  不是我发的请求
                                    Log.d("VideoCallActivity","接通成功 ---  我发起的视频聊天请求 可通话" + minCount + "分钟");
                                    //计时
                                            ...
                                            try {
                                                ...
                                                uiHandler.post(new Runnable() {
                                                    ...
                                                    public void run() {
                                                        ...
                                                        Toast.makeText(VideoCallActivity.this,"信用不足，通话已结束",Toast.LENGTH_LONG).show();
                                                    }
                                                });
                                    ...
                                    Log.d("VideoCallActivity", "接通成功 ---  不是我发起的视频聊天请求");
                                }
                    ...
                    case DISCONNNECTED: // 电话断了
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                String s6 = getResources().getString(R.string.hang_up);//挂断
                                String s7 = getResources().getString(R.string.The_other_is_hang_up);//对方挂断
                                String s8 = getResources().getString(R.string.did_not_answer);//未接听
                                String s9 = getResources().getString(R.string.Has_been_cancelled);//已取消
...
//                                        callStateTextView.setText(s6);
                                            //Toast.makeText(VideoCallActivity.this,s6,Toast.LENGTH_LONG).show();
                                        } else {
                                            callStateTextView.setText(s7);
                                            //Toast.makeText(VideoCallActivity.this,s7,Toast.LENGTH_LONG).show();
                                        }
                                        if (isInComingCall == false){//总是接听方的显示  不是我发的请求
                                            //Toast.makeText(VideoCallActivity.this,"我发起的视频聊天请求",Toast.LENGTH_LONG).show();
                                            Log.d("VideoCallActivity","我发起的视频聊天请求");
                                            //信用转移
                                        }else{
                                            //Toast.makeText(VideoCallActivity.this,"不是我发起的视频聊天请求",Toast.LENGTH_LONG).show();
                                            Log.d("VideoCallActivity", "不是我发起的视频聊天请求");
                                            //信用转移,,获取来电username——from_username
                                            //分钟数min_count
                                            String[] arr_time = callDruationText.split(":");
                                            String str_min;
                                            int min_count = 0;
                                            if (arr_time.length==2){
                                                str_min = arr_time[0];
                                                min_count = Integer.valueOf(str_min) + 1;
                                            }else if(arr_time.length == 3){
                                                int hour = Integer.valueOf(arr_time[0]);//小时数
                                                min_count = hour*60 + Integer.valueOf(arr_time[1]) + 1;
                                            }

                                            OkhttpUtil.getVideoCallIncome(this_handler,min_count+"",username);
                                        }
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_hangup_call: // 挂断电话
                ...
                if (isInCalling==false){
                    //Toast.makeText(VideoCallActivity.this,"是我发起的视频聊天",Toast.LENGTH_LONG).show();
                }else{
                    //Toast.makeText(VideoCallActivity.this,"不是我发起的视频聊天",Toast.LENGTH_LONG).show();
                }
