 ...
 */
public class FansItemBaseAdapter extends BaseAdapter {
    private List<FansUserItem> list_fans_user_item;
    private LayoutInflater inflater;
    private Context context;

    public FansItemBaseAdapter(Context context,List<FansUserItem> list_fans_user_item){
        this.context = context;
        this.list_fans_user_item = list_fans_user_item;
    ...
    public View getView(int position, final View convertView, ViewGroup parent) {
        final  FansUserItem fansUserItem = list_fans_user_item.get(position);
        View view;
        ViewHolder viewHolder;
        if (convertView==null){
            view = inflater.inflate(R.layout.fans_item,parent,false);
            viewHolder = new ViewHolder();
            viewHolder.iv_head = (ImageView)view.findViewById(R.id.id_fans_user_item_iv_head);
            viewHolder.iv_vip_logo = (ImageView)view.findViewById(R.id.id_fans_user_item_iv_vip_logo);
            viewHolder.tv_nickname = (TextView)view.findViewById(R.id.id_fans_user_item_tv_nickname);
            viewHolder.tv_distance = (TextView)view.findViewById(R.id.id_fans_user_item_tv_distance);
            viewHolder.tv_signature= (TextView)view.findViewById(R.id.id_fans_user_item_tv_signature);
            viewHolder.tv_sex_age = (TextView)view.findViewById(R.id.id_fans_user_item_tv_sex_age);
            viewHolder.tv_occupation = (TextView)view.findViewById(R.id.id_fans_user_item_tv_occupation);
        ...
        viewHolder.tv_nickname.setText(fansUserItem.getNickname());
        viewHolder.tv_distance.setText(fansUserItem.getDistance() + " km");
        viewHolder.tv_sex_age.setText(fansUserItem.getSex() + " " + fansUserItem.getAge());
        viewHolder.tv_occupation.setText(fansUserItem.getOccupation());
        viewHolder.tv_signature.setText(fansUserItem.getSignature());
        Glide.with(context)
                .load(WebUtil.HTTP_ADDRESS + fansUserItem.getUser_head_path())
                .into(viewHolder.iv_head);


        if (fansUserItem.getSex().equals("男")){
        ...
        viewHolder.iv_head.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("image_path", WebUtil.HTTP_ADDRESS + fansUserItem.getUser_head_path());
                context.startActivity(intent);
            }
        });

        switch (fansUserItem.getOccupation()){
            case "学生":
    ...
    public Object getItem(int i) {
        return list_fans_user_item.get(i);
    }

    @Override
    public int getCount() {
        return list_fans_user_item.size();
    }
